...
static void CDAudio_Eject( void )
{
	...
	dwReturn = mciSendCommand( wDeviceID, MCI_SET, MCI_SET_DOOR_OPEN, ( LONG_PTR ) NULL );
	if ( dwReturn )
...
static void CDAudio_CloseDoor( void )
{
	...
	dwReturn = mciSendCommand( wDeviceID, MCI_SET, MCI_SET_DOOR_CLOSED, ( LONG_PTR ) NULL );
	if ( dwReturn )
...
void CDAudio_Stop( void )
{
	...
	dwReturn = mciSendCommand( wDeviceID, MCI_STOP, 0, ( LONG_PTR ) NULL );
	if ( dwReturn )
...
void CDAudio_Pause( void )
{
	...
	dwReturn = mciSendCommand( wDeviceID, MCI_PAUSE, 0, ( LONG_PTR ) ( LPVOID ) &mciGenericParms );
	if ( dwReturn )
...
int CDAudio_Init( void )
{
	...
	dwReturn = mciSendCommand( 0, MCI_OPEN, MCI_OPEN_TYPE | MCI_OPEN_SHAREABLE, ( LONG_PTR ) ( LPVOID ) &mciOpenParms );
	if ( dwReturn )
	{
	...
	dwReturn = mciSendCommand( wDeviceID, MCI_SET, MCI_SET_TIME_FORMAT, ( LONG_PTR ) ( LPVOID ) &mciSetParms );
	if ( dwReturn )
	{

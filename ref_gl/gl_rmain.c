...
void R_Clear(void) {
  if (gl_ztrick->value) {
    ...
    if (gl_clear->value) qglClear(GL_COLOR_BUFFER_BIT);
  ...
  */
  ...
  if (strstr(gl_config.extensions_string, "GL_EXT_point_parameters")) {
    if (gl_ext_pointparameters->value) {
      ...
      qglPointParameterfvEXT = (void(APIENTRY *)(
          GLenum, const GLfloat *))qwglGetProcAddress("glPointParameterfvEXT");
  ...
  if (strstr(gl_config.extensions_string, "3DFX_set_global_palette")) {
    if (gl_ext_palettedtexture->value) {
      ...
      qgl3DfxSetPaletteEXT =
          (void(APIENTRY *)(GLuint *))qwglGetProcAddress("gl3DfxSetPaletteEXT");
  ...
  if (strstr(gl_config.extensions_string, "GL_ARB_multitexture")) {
    if (gl_ext_multitexture->value) {
      ...
      qglClientActiveTextureARB =
          (void *)qwglGetProcAddress("glClientActiveTextureARB");

...
field_t fields[] = {
        ...
        { "move_origin", FOFS( move_origin ), F_VEC3 },
        { "move_angles", FOFS( move_angles ), F_VEC3 },
        ...
        { "origin", FOFS( s.origin ), F_VEC3 },
        { "angles", FOFS( s.angles ), F_VEC3 },
        ...
        { "skyaxis", STOFS( skyaxis ), F_VEC3, FFL_SPAWNTEMP },
        ...
        // 'nox fields
        { "fog", STOFS( fog ), F_VEC4, FFL_SPAWNTEMP },
        { "offset", FOFS( offset ), F_VEC3 },
        { "scale", FOFS( s.scale ), F_VEC3 },
